        ...
        <div className="row g-4">
          <div className="col-lg-4 col-md-6 col-sm-12">
            <div className="footer-brand">
              <div className="logo-container">
                <svg className="logo-svg footer-logo" viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="footer-description">
                We're dedicated to helping people achieve their goals and creating stronger, more compassionate communities.
              </p>
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-6 col-sm-12">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/needy-requests">Needy Requests</a></li>
              <li><a href="/donor-requests">Donor Requests</a></li>
            </ul>
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            ...
            <p className="footer-description">Stay connected with us on social media</p>
